...
| Authentication | HTTPS OAuth 2.0 / Supabase Auth | Google or Microsoft Entra identity, browser session, refresh token. |
...
graph TB
    ...
    OFM --> SW
    SupabaseClient --> Auth[Supabase Auth and Google/Microsoft OAuth]
