...
| Screens | `src/screens` | User workflows for menu, ride, exploration overview, history, summary, wallet, settings, and offline maps. |
| Shared UI | `src/components` | Reusable account, currency, and subpage presentation. |
| Map components | `src/map` | Live map with heading-up and breadcrumb overlays, world exploration overview, historical route map, style selection, marker, and fog layers. |
