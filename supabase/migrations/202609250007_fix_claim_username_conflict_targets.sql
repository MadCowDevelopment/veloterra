-- Use constraint names for conflict handling because the returned OUT fields
-- overlap with the indexed column names in this SECURITY DEFINER function.
...
begin
  ...
  on conflict on constraint username_claims_pkey do nothing;
